    ...
    <div className="flex flex-col min-h-screen bg-white">
          ...
          <div className="absolute inset-0">
            ...
            <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
              <div className="text-center px-4 max-w-3xl text-white">
                ...
                <p className="text-xl md:text-2xl mb-8 text-white">Happy drivers, happy riders, and a better environment.</p>
              </div>
            </div>
          </div>
        </section>
      ...
      <footer id="contact" className="bg-gray-800 text-white py-12 px-4">
        <div className="max-w-6xl mx-auto grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <address className="text-white not-italic space-y-2">
              <p className="text-white hover:text-orange-300 transition-colors">Ngong Road, Nairobi</p>
              <p className="text-white hover:text-orange-300 transition-colors">Kenya</p>
              <p className="text-white hover:text-orange-300 transition-colors">info@volo.africa</p>
              <p className="text-white hover:text-orange-300 transition-colors">+254 746 821 567</p>
            </address>
          </div>
        ...
        <div className="max-w-6xl mx-auto mt-8 pt-8 border-t border-gray-700 text-center">
          <p className="text-gray-300">&copy; {new Date().getFullYear()} Volo Africa. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
